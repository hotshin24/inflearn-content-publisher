...
4. 대상 인프런 강의 페이지를 새로고침합니다.
5. 확장 아이콘에서 **수집 → 초안 생성 → 워드프레스 전송** 순으로 진행합니다.

커리큘럼이나 수강평이 접혀 있거나 추가 로딩되는 경우 먼저 페이지에서 펼치기/더보기를 누른 뒤 수집하세요. DOM 구조가 바뀌면 `extension/content.js`의 추출 규칙을 조정해야 합니다.
